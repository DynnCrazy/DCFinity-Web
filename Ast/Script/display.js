...
const botDesc = "DCFinity adalah bot seru berbahasa Indonesia yang dimana bisa membuat kamu bahagia dan tertawa tanpa batas (infinity). Bot ini memiliki perintah seperti fun, minigames, & utility."
const thisYear = "2025"
